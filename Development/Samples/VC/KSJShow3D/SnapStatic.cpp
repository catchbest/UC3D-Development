...
bool CSnapStatic::UpdateImage(BYTE *pImageData, int nCaptureWidth, int nCaptureHeight, int nBitCount)
{
	if (TryEnterCriticalSection(&m_csImagedata))
	{
		if (m_pPreviewBmpInfo->bmiHeader.biWidth != nCaptureWidth
